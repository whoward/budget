...
require 'budget/reports/monthly_cashflow_report'

describe Budget::MonthlyCashflowReport do
  ...
  describe '#income' do
    ...
    it "doesn't include transactions outside the current month" do
      create(:transaction, cents: 1, category: work, date: Time.zone.now.at_beginning_of_month - 1.day)
      create(:transaction, cents: 10, category: work, date: Time.zone.now.at_beginning_of_month)
      create(:transaction, cents: 100, category: work, date: Time.zone.now)
      create(:transaction, cents: 1000, category: work, date: Time.zone.now.at_end_of_month)
      create(:transaction, cents: 10_000, category: work, date: Time.zone.now.at_end_of_month + 1.day)
  ...
  describe '#expenses' do
    ...
    it "doesn't include transactions outside the current month" do
      create(:transaction, cents: 1, category: rent, date: Time.zone.now.at_beginning_of_month - 1.day)
      create(:transaction, cents: 10, category: rent, date: Time.zone.now.at_beginning_of_month)
      create(:transaction, cents: 100, category: rent, date: Time.zone.now)
      create(:transaction, cents: 1000, category: rent, date: Time.zone.now.at_end_of_month)
      create(:transaction, cents: 10_000, category: rent, date: Time.zone.now.at_end_of_month + 1.day)
  ...
  describe '#net_income' do
    it 'is the number of cents difference between the income and expense categories' do
      create(:transaction, cents: 10_000, category: work)
